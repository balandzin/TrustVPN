...
struct VpnServers : Codable, Equatable {
    ...
    var persistentServerName: String?
}
...
struct Texts : Codable {
    ...
    let termsAcceptButton: String?
    let continueButton: String?
    let onboard1Title: String?
    let onboard1SubTitle: String?
    let onboard2Title: String?
    let onboard2SubTitle: String?
    let onboard3Title: String?
    let onboard3SubTitle: String?
    let vpnService: String?
    let deviceSearch: String?
    let passwordSecurity: String?
    let options: String?
    let serverNotSelected: String?
    let serverNotSelectedDescription: String?
    let selectServer: String?
    let vpnServers: String?
    let select: String?
    let added: String?
    let connected: String?
    let disconnected: String?
    let renameServer: String?
    let removeServer: String?
    let removeDescription: String?
    let remove: String?
    let renameServerPlaceholder: String?
    let cancel: String?
    let save: String?
    let dataIsSecure: String?
    let great: String?
    ...
    let mediumPassword: String?
    let strongPassword: String?
    let crackedDescriptionLabel: String?
    let howToCreateStrongPasswords: String?
    let howToCreateStrongPasswordsDescription: String?
    let whyIsPasswordSecurityImportant: String?
    let whyIsPasswordSecurityImportantDescription: String?
    let howOurToolWorks: String?
    let howOurToolWorksDescription: String?
    let typesOfPasswordAttacks: String?
    let typesOfPasswordAttacksDescription: String?
    let sec: String?
    let min: String?
    let hours: String?
    let startScanning: String?
    let stop: String?
    ...
    let changeIcon: String?
    let supportAndFAQ: String?
    let privatePolicy: String?
    let termsOfUse: String?
    let ipAdress: String?
    let versionIVP: String?
    let asn: String?
    let timeZone: String?
    ...
    let faqLabel: String?
    let howDoesTheDeviceSearchWork: String?
    let howDoesPasswordSecurityWork: String?
    let howDoesVpnWork: String?
    let welcomeToDeviceSearch: String?
    let informationOnTheIndicator: String?
    let welcomeToPasswordSecurityDescription: String?
    let indicatorDescription: String?
    let goToUse: String?
    let passwordSecurityDescription: String?
    let vpnDescription: String?
    let goToSupport: String?
    let privatePolicyCapital: String?
    let privatePolicyDescription: String?
