...
final class VpnBottomSheetController: BottomSheetController {
    // MARK: - GUI Variables
    ...
    private lazy var titleLabel: UILabel = {
        let label = UILabel()
        label.text = AppText.howDoesVpnWork
    ...
    private lazy var permissionLabel: UILabel = {
        let label = UILabel()
        label.text = AppText.vpnDescription
        label.textColor = AppColors.dataSecurityLabel
...
extension VpnBottomSheetController {
