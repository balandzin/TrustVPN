...
class BottomSheetTransitioningDelegate: NSObject, UIViewControllerTransitioningDelegate {
    ...
    func animationController(
        ...
        bottomSheetPresentationController.closeSwipe = { [weak self] in
...
class BottomSheetPresentationController: UIPresentationController {
    ...
    override func presentationTransitionWillBegin() {
        ...
        let preferredHeightConstraint = presentedView.heightAnchor.constraint(equalToConstant: UIScreen.height)
...
class BottomSheetInteractiveDismissalTransition: NSObject {
    
    let stretchOffset: CGFloat = 16
    let maxTransitionDuration: CGFloat = 0.25
    let minTransitionDuration: CGFloat = 0.15
    let animationCurve: UIView.AnimationCurve = .easeIn
    
    weak var transitionContext: UIViewControllerContextTransitioning?
    
    var heightAnimator: UIViewPropertyAnimator?
